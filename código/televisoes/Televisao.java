...
public abstract class Televisao  {
    ...
    public void informarDados(){
        if (canal_atual.isHD())
            System.out.println("O canal atual eh: " + canal_atual.getNome() + " - Numero do canal:  " + canal_atual.getNumero() + " - Canal digital (HD)\n");
        
        else
           System.out.println("O canal atual eh: " + canal_atual.getNome() + " - Numero do canal:  " + canal_atual.getNumero() + " - Canal analogico\n");
    ...
    public void mostrarGrade(){
        Collections.sort(canais_disp, new SortByNumber());
            ...
            {
            if (c.isHD())
            System.out.println("Numero do canal: " + c.getNumero() + " - " + c.getNome() + " - Canal digital (HD)\n");
            else
            System.out.println("Numero do canal: " + c.getNumero() + " - " + c.getNome() + " - Canal analogico\n");    
            }  	
    }
}